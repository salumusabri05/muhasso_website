      ...
      <main className="container mx-auto px-6 py-8 pt-28">
        ...
        >
          <div className="relative w-40 h-40 mb-6 md:mb-0">
            <Image 
              src="/asscociation_details/TAMIRASA(TANZANIA MEDICAL IMAGING STUDENTS ASSOCIATION).jpg"
              alt="TAMIRASA Logo"
              fill
          ...
          <div className="text-center md:text-left">
            ...
            >
              Tanzania Medical Imaging Students Association
            </motion.h1>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-red-900 mb-4">
              TAMIRASA News & Updates
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Latest news and announcements from the Medical Imaging Students Association
            </p>
          </div>
          
          {/* Use real News component filtered by TAMIRASA association */}
          <News association="TAMIRASA" showAll={false} />
        </motion.div>
      </main>
