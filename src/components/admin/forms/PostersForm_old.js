...
const PostersForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Poster Form Submission:', formData);
      ...
      >
        ...
        <motion.div className="mb-5" variants={itemVariants}>
          ...
          <select
            ...
            onChange={handleInputChange}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-black bg-white"
          >
        ...
        <motion.div className="mb-7" variants={itemVariants}>
          ...
          <input
            ...
            onChange={handleInputChange}
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-black"
            placeholder="Enter creator's name or department"
          />
        </motion.div>
